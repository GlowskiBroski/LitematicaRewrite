...
public class ChunkRenderDispatcherLitematica {
    private static final Logger LOGGER = LitematicaRewrite.LOGGER;
    ...
    public ChunkRenderDispatcherLitematica() {
        ...
        if (threadLimitCPU > 1)
        {
            LitematicaRewrite.LOGGER.info("Creating {} render threads", threadLimitCPU);
        ...
        */
        ...
        LitematicaRewrite.LOGGER.info("Using {} total BufferBuilder caches", this.countRenderBuilders + 1);
    ...
    public ListenableFuture<Object> uploadChunkBlocks(final RenderType layer, final BufferBuilder buffer, final ChunkRendererSchematicVbo renderChunk, final ChunkRenderDataSchematic chunkRenderData, final double distanceSq) {
        if (MC.isSameThread()) {
    ...
    public ListenableFuture<Object> uploadChunkOverlay(final OverlayRenderType type, final BufferBuilder buffer, final ChunkRendererSchematicVbo renderChunk, final ChunkRenderDataSchematic compiledChunk, final double distanceSq) {
        if (MC.isSameThread()) {
