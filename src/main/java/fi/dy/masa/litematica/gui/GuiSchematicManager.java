...
public class GuiSchematicManager extends GuiSchematicBrowserBase implements ISelectionListener<DirectoryEntry> {
    ...
    public enum ExportType implements IConfigOptionListEntry {
        SCHEMATIC("Schematic"), VANILLA("Vanilla Structure");
    ...
    private static class ButtonListener implements IButtonActionListener {
        ...
        public void actionPerformedWithButton(ButtonBase button, int mouseButton) {
            ...
            if (this.type == Type.EXPORT_SCHEMATIC) {
                ...
                if (fileType == FileType.LITEMATICA_SCHEMATIC || fileType == FileType.SCHEMATICA_SCHEMATIC || fileType == FileType.VANILLA_STRUCTURE) {
        ...
        public enum Type {
            IMPORT_SCHEMATIC("litematica.gui.button.import"), EXPORT_SCHEMATIC("litematica.gui.button.schematic_manager.export_as"), RENAME_SCHEMATIC("litematica.gui.button.rename"), DELETE_SCHEMATIC("litematica.gui.button.delete"), SET_PREVIEW("litematica.gui.button.set_preview", "litematica.info.schematic_manager.preview.right_click_to_cancel"), EXPORT_TYPE("");
        ...
        public void createAndSetPreviewImage() {
            ...
            if (schematic != null) {
                try {
                    ...
                    LitematicaRewrite.LOGGER.warn("Exception while creating preview image", e);
                }
            } else {
