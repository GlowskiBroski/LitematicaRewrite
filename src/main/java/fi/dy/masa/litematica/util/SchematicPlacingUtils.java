...
public class SchematicPlacingUtils {
        ...
        try {
            ...
            for (String regionName : regionsTouchingChunk) {
                ...
                if (placement.isEnabled()) {
                    ...
                    if (!placeBlocksWithinChunk(world, chunkPos, regionName, container, blockEntityMap, origin, schematicPlacement, placement, scheduledBlockTicks, scheduledFluidTicks, replace, notifyNeighbors)) {
                        allSuccess = false;
                    ...
                    if (!schematicPlacement.ignoreEntities() && !placement.ignoreEntities() && entityList != null) {
    ...
    public static boolean placeBlocksWithinChunk(World world, ChunkPos chunkPos, String regionName, LitematicaBlockStateContainer container, Map<BlockPos, NbtCompound> blockEntityMap, BlockPos origin, SchematicPlacement schematicPlacement, SubRegionPlacement placement, @Nullable Map<BlockPos, OrderedTick<Block>> scheduledBlockTicks, @Nullable Map<BlockPos, OrderedTick<Fluid>> scheduledFluidTicks, ReplaceBehavior replace, boolean notifyNeighbors) {
    ...
    public static void placeEntitiesToWorldWithinChunk(World world, ChunkPos chunkPos, List<EntityInfo> entityList, BlockPos origin, SchematicPlacement schematicPlacement, SubRegionPlacement placement) {
        BlockPos regionPos = placement.getPos();
            ...
            if (x >= minX && x < maxX && z >= minZ && z < maxZ) {
                ...
                if (entity != null) {
                    ...
                    if (entity instanceof PaintingEntity paintingEntity) {
                        ...
                        if ((paintingEntity.getWidthPixels() % 32) == 0 && right.getDirection() == AxisDirection.POSITIVE) {
